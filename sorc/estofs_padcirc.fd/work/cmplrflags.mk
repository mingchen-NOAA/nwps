...
#  ZHOME         :=
  ifeq ($(NETCDFen),enable)
     FLIBS := $(FLIBS) \
     ${NETCDFHOME}/lib/libnetcdff.a \
     ${NETCDFHOME}/lib/libnetcdf.a \
     $(HDF5HOME)/lib/libhdf5hl_fortran.a \
     $(HDF5HOME)/lib/libhdf5_fortran.a \
     $(HDF5HOME)/lib/libhdf5_hl.a \
     $(HDF5HOME)/lib/libhdf5.a \
     $(Z_LIB)
  endif
